...
export const feGroup = [
  {
    icon: html5,
    name: 'HTML',
    domain: 'https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5',
  },
  {
    icon: css3,
    name: 'CSS',
    domain: 'https://developer.mozilla.org/en-US/docs/Web/CSS',
  },
  {
    icon: javascriptIcon,
    name: 'Javascript',
  ...
  },
  {
    icon: reactIcon,
    name: 'React',
    domain: 'https://reactjs.org/docs/getting-started.html',
  },
  {
    icon: reduxIcon,
    name: 'Redux',
    domain: 'https://redux.js.org/introduction/getting-started',
  },
  {
    icon: bootstrapIcon,
    name: 'Bootstrap',
    domain: 'https://getbootstrap.com/docs/5.0/getting-started/introduction/',
  },
  {
    icon: antDesign,
    name: 'Ant Design',
    domain: 'https://ant.design/docs/react/introduce',
  },
  {
    icon: semanticUi,
    name: 'Semantic UI',
...
export const beGroup = [
  {
    icon: fileTypeMongo,
    name: 'MongoDB',
    domain: 'https://www.mongodb.com/1',
  },
  {
    icon: nodejsIcon,
    name: 'NodeJS',
    domain: 'https://nodejs.org/en/',
  },
  {
    icon: firebaseIcon,
    name: 'FireBase',
